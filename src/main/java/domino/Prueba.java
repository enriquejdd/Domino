...
public class Prueba {
    ...
    public static int leerSup() {
        Scanner teclado = new Scanner(System.in);
        int valorSuperior = 0;
        do {
            System.out.println("¿Qué valores es el superior?");
            try {
    ...
    // Creamos un método que pregunte por el valor inferior de la ficha
    public static int leerInf() {
        Scanner teclado = new Scanner(System.in);
        int valorInferior = 0;
        do {
            System.out.println("¿Qué valores es el inferior?");
            try {
                valorInferior = teclado.nextInt();

            } catch (InputMismatchException ime) {
                teclado.nextLine();
            }

        } while (valorInferior < 0 || valorInferior > 7);
    ...
    public static void main(String[] args) {
        ...
        FichaDomino f1 = new FichaDomino(leerSup(), leerInf());
        System.out.println("");
        System.out.println("Ficha f2");
        FichaDomino f2 = new FichaDomino(leerSup(), leerInf());
        System.out.println("");
